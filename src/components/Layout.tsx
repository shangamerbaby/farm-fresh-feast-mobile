        ...
        <div className="flex items-center justify-around py-2">
          <Link 
            ...
            className={`flex flex-col items-center p-2 ${
              location.pathname === '/' ? 'text-primary' : 'text-gray-500 dark:text-gray-400'
            }`}
          >
            <Home size={20} />
          ...
          <Link 
            to="/categories" 
            className={`flex flex-col items-center p-2 ${
              location.pathname === '/categories' ? 'text-primary' : 'text-gray-500 dark:text-gray-400'
            }`}
          >
            <Menu size={20} />
          ...
          <Link 
            ...
            className={`flex flex-col items-center p-2 relative ${
              location.pathname === '/cart' ? 'text-primary' : 'text-gray-500 dark:text-gray-400'
            }`}
          >
            <ShoppingBag size={20} />
            {totalItems > 0 && (
          ...
          <Link 
            to="/account" 
            className={`flex flex-col items-center p-2 ${
              location.pathname === '/account' ? 'text-primary' : 'text-gray-500 dark:text-gray-400'
            }`}
          >
            <User size={20} />
